...
validate: lint build validate--skip-checks--update8 validate--skip-checks--version-1 validate--skip-checks--version-1-1
...
validate--skip-checks--version-1-1:
	@npm run validate--version-1.1
