...
} from '../classes/CoreUObject/FGBuildableDroneStation.js';

import type {
	common_base__FGBuildableBlueprintDesigner__type
} from '../classes/CoreUObject/FGBuildableBlueprintDesigner.js';
...
} from '../classes/CoreUObject/FGBuildableMAM.js';

import type {
	common_base__FGBuildableRailroadTrack__type
} from '../classes/CoreUObject/FGBuildableRailroadTrack.js';

import type {
	common_base__FGBuildableWire__type
} from '../classes/CoreUObject/FGBuildableWire.js';

import type {
	common_base__FGBuildablePowerPole__type
} from '../classes/CoreUObject/FGBuildablePowerPole.js';

import type {
	common_base__FGBuildableTradingPost__type
} from '../classes/CoreUObject/FGBuildableTradingPost.js';

import type {
	common_base__FGBuildablePillarLightweight__type
} from '../classes/CoreUObject/FGBuildablePillarLightweight.js';
...
} from '../classes/CoreUObject/FGBuildableWalkwayLightweight.js';

import type {
	common_base__FGBuildableGenerator__base__type
} from '../classes/CoreUObject/FGBuildableGenerator.js';
...
} from '../classes/CoreUObject/FGBuildableGeneratorGeoThermal.js';
...
} from '../classes/CoreUObject/FGBuildablePipeline.js';

import type {
	common_base__FGBuildableWaterPump__type
} from '../classes/CoreUObject/FGBuildableWaterPump.js';

import type {
	common_base__FGBuildableResourceSink__type
} from '../classes/CoreUObject/FGBuildableResourceSink.js';

import type {
	common_base__FGBuildableResourceSinkShop__type
} from '../classes/CoreUObject/FGBuildableResourceSinkShop.js';

import type {
	common_base__FGItemDescriptorBiomass__type
} from '../classes/CoreUObject/FGItemDescriptorBiomass.js';
...
} from '../classes/CoreUObject/FGPortableMinerDispenser.js';
...
} from '../classes/CoreUObject/FGBuildableFrackingExtractor.js';

import type {
	common_base__FGBuildableFrackingActivator__type
} from '../classes/CoreUObject/FGBuildableFrackingActivator.js';

import type {
	common_base__FGBuildableRailroadSignal__type
} from '../classes/CoreUObject/FGBuildableRailroadSignal.js';

import type {
	common_base__FGBuildableTrainPlatform__base__type
} from '../classes/CoreUObject/FGBuildableTrainPlatform.js';
...
} from '../classes/CoreUObject/FGBuildableRailroadStation.js';

import type {
	common_base__FGBuildableStorage__type
} from '../classes/CoreUObject/FGBuildableStorage.js';

import type {
	common_base__FGPipeHyperStart__type
} from '../classes/CoreUObject/FGPipeHyperStart.js';

import type {
	common_base__FGBuildablePipeHyper__type
} from '../classes/CoreUObject/FGBuildablePipeHyper.js';

import type {
	common_base__FGBuildablePowerStorage__type
} from '../classes/CoreUObject/FGBuildablePowerStorage.js';

import type {
	common_base__FGBuildableDockingStation__type
} from '../classes/CoreUObject/FGBuildableDockingStation.js';

import type {
	common_base__FGBuildableJumppad__type
} from '../classes/CoreUObject/FGBuildableJumppad.js';

import type {
	common_base__FGBuildableAttachmentMerger__type
} from '../classes/CoreUObject/FGBuildableAttachmentMerger.js';

import type {
	common_base__FGBuildableAttachmentSplitter__type
} from '../classes/CoreUObject/FGBuildableAttachmentSplitter.js';

import type {
	common_base__FGBuildableSplitterSmart__type
} from '../classes/CoreUObject/FGBuildableSplitterSmart.js';
...
} from '../classes/CoreUObject/FGBuildableRamp.js';
...
} from '../classes/CoreUObject/FGAmmoTypeSpreadshot.js';
...
} from '../classes/CoreUObject/FGChargedWeapon.js';

import type {
	common_base__FGBuildablePriorityPowerSwitch__type
} from '../classes/CoreUObject/FGBuildablePriorityPowerSwitch.js';

import type {
	common_base__FGBuildableCircuitSwitch__type
} from '../classes/CoreUObject/FGBuildableCircuitSwitch.js';

import type {
	common_base__FGBuildableRadarTower__type
} from '../classes/CoreUObject/FGBuildableRadarTower.js';

import type {
	common_base__FGBuildableSnowDispenser__type
} from '../classes/CoreUObject/FGBuildableSnowDispenser.js';

import type {
	common_base__FGBuildableFactorySimpleProducer__type
} from '../classes/CoreUObject/FGBuildableFactorySimpleProducer.js';

import type {
	common_base__FGBuildableLadder__type
} from '../classes/CoreUObject/FGBuildableLadder.js';

import type {
	common_base__FGGolfCartDispenser__type
} from '../classes/CoreUObject/FGGolfCartDispenser.js';

import type {
	common_base__FGBuildablePassthrough__type
} from '../classes/CoreUObject/FGBuildablePassthrough.js';

import type {
	common_base__FGBuildableLightsControlPanel__type
} from '../classes/CoreUObject/FGBuildableLightsControlPanel.js';
...
} from '../classes/CoreUObject/FGBuildableFloodlight.js';

import type {
	common_base__FGBuildableWidgetSign__type
} from '../classes/CoreUObject/FGBuildableWidgetSign.js';

import type {
	common_base__FGBuildableBeamLightweight__type
} from '../classes/CoreUObject/FGBuildableBeamLightweight.js';

import type {
	common_base__FGBuildableFactoryBuilding__type
} from '../classes/CoreUObject/FGBuildableFactoryBuilding.js';

import type {
	common_base__FGBuildableSpaceElevator__type
} from '../classes/CoreUObject/FGBuildableSpaceElevator.js';
...
} from '../classes/CoreUObject/FGHoverPack.js';

import type {
	common_base__FGJetPack__type
} from '../classes/CoreUObject/FGJetPack.js';

import type {
	common_base__FGSuitBase__type
} from '../classes/CoreUObject/FGSuitBase.js';

import type {
	common_base__FGGasMask__type
} from '../classes/CoreUObject/FGGasMask.js';

import type {
	common_base__FGChainsaw__type
} from '../classes/CoreUObject/FGChainsaw.js';

import type {
	common_base__FGObjectScanner__type
} from '../classes/CoreUObject/FGObjectScanner.js';

import type {
	common_base__FGJumpingStilts__type
} from '../classes/CoreUObject/FGJumpingStilts.js';

import type {
	common_base__FGEquipmentZipline__type
} from '../classes/CoreUObject/FGEquipmentZipline.js';

import type {
	common_base__FGParachute__type
} from '../classes/CoreUObject/FGParachute.js';
...
} from '../classes/CoreUObject/FGBuildablePipelineJunction.js';
...
} from '../classes/CoreUObject/FGBuildablePipeReservoir.js';

import type {
	common_base__FGBuildablePoleLightweight__type
} from '../classes/CoreUObject/FGBuildablePoleLightweight.js';
...
} from '../classes/CoreUObject/FGResourceDescriptor.js';

import type {
	common_base__FGRecipe__type
} from '../classes/CoreUObject/FGRecipe.js';
...
} from '../classes/CoreUObject/FGBuildableCornerWall.js';
...
} from '../classes/CoreUObject/FGBuildableConveyorLift.js';

import type {
	common_base__FGPoleDescriptor__type
} from '../classes/CoreUObject/FGPoleDescriptor.js';
