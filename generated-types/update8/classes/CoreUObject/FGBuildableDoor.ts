...
export type FGBuildableDoor__type = FGBuildableDoor__merged__type;

export type FGBuildableDoor__automated__type =
	FGBuildableDoor__automated__merged__type;

export type FGBuildableDoor__automated__merged__type =
	common_base__FGBuildableDoor__automated__type &
