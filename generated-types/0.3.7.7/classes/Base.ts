...
type FGBuildable_base = FGBuildable_base_pre_1_0 & FGBuildable_base_pre_update5 & FGBuildable_base_version_specific;
...
type FGBuildable_docking_station_base_with_mMapText = {
	mMapText: string,
};
...
type FGBuildable_powered = FGBuildable_base & FGBuildable_powered_pre_1_0 & FGBuildable_powered_pre_update4 & FGBuildable_powered_version_specific & has_mNumCyclesForProductivity & has_mSignificanceRange;

type FGBuildable_powered_base_resources_base = docs_json_ts_0_3_7_7_classes_base_overridable_FGBuildableResourceExtractor_only_allow_certain_resources & FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & has_mNumCyclesForProductivity;
...
type FGBuildable_powered_storage_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildable_powered_storage_base_base & has_mNumCyclesForProductivity;

type FGBuildable_powered_storage_base_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildable_powered_storage_base_base_base & has_mNumCyclesForProductivity;

type FGBuildable_powered_storage_base_base_base = {
...
type FGBuildableAttachment_base = FGBuildable_base & FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableAttachment_has_mCurrentInventoryIndex & has_mNumCyclesForProductivity;
...
type FGBuildableAttachment_splitter_base = FGBuildable_base & FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableAttachment_base & FGBuildableAttachment_has_mCurrentInventoryIndex & FGBuildableAttachment_splitter_base_base_base & has_mNumCyclesForProductivity;
...
type FGBuildableAttachmentMerger_base = FGBuildable_base & FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableAttachment_base & FGBuildableAttachment_has_mCurrentInventoryIndex & FGBuildableAttachmentMerger_version_specific & has_mNumCyclesForProductivity;
...
type FGBuildableConveyorLift = docs_json_ts_common_classes_FGBuildableConveyorLift & FGBuildable_base & FGBuildableConveyorBelt_pre_1_0 & FGBuildableConveyorBelt_pre_update8 & FGBuildableConveyorLift_base;
...
type FGBuildableDockingStation = docs_json_ts_common_classes_FGBuildableDockingStation & FGBuildable_docking_station & FGBuildableDockingStation_base & FGBuildableDockingStation_base_base;
...
type FGBuildableFactory_jump_pad_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableFactory_jump_pad_base_base & has_mNumCyclesForProductivity;

type FGBuildableFactory_jump_pad_base_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableFactory_jump_pad_base_base_base & has_mNumCyclesForProductivity;
...
type FGBuildableFactory_landing_pad_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableFactory_landing_pad_base_base & has_mNumCyclesForProductivity;

type FGBuildableFactory_landing_pad_base_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableFactory_landing_pad_base_base_base & has_mNumCyclesForProductivity;
...
type FGBuildableFactory_landing_pad_version_specific = {
	mDampeningFactor: docs_json_ts_common_types_decimal_string,
	mPlayerList: '',
};
...
type FGBuildableFactorySimpleProducer_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableFactorySimpleProducer_base_base & has_mNumCyclesForProductivity;

type FGBuildableFactorySimpleProducer_base_base = {
	mTimeToProduceItem: docs_json_ts_common_types_decimal_string,
	mEventType: 'EV_Christmas',
};

type FGBuildableFoundation = docs_json_ts_common_classes_FGBuildableFoundation & FGBuildable_base & has_mDisableAttachmentSnapOn & has_mDisableSnapOn & has_mElevation & has_mHeight & has_mSize;

type FGBuildableGenerator = FGBuildableGenerator_base & FGBuildableGenerator_no_fuel;

type FGBuildableGenerator_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableGenerator_base_base_base & FGBuildableGenerator_base_base_pre_1_0 & FGBuildableGenerator_no_fuel_base_base & FGBuildableGenerator_no_fuel_base_base_base_base & has_mNumCyclesForProductivity;
...
type FGBuildableGenerator_no_fuel_base_base_base_base = {
...
type FGBuildableGeneratorFuel_coal = docs_json_ts_common_classes_FGBuildableGeneratorFuel & FGBuildable_base & FGBuildableGenerator & FGBuildableGeneratorFuel_coal_base;
...
type FGBuildableGeneratorGeoThermal_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableGenerator_no_fuel_base_base & FGBuildableGeneratorGeoThermal_base_base & has_mNumCyclesForProductivity;

type FGBuildableGeneratorGeoThermal_base_base = FGBuildableGenerator_no_fuel_base_base & FGBuildableGenerator_no_fuel_base_base_base_base & FGBuildableGeneratorGeoThermal_base_base_base;

type FGBuildableGeneratorGeoThermal_base_base_base = {
...
type FGBuildableJumppad_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableJumppad_base_base & has_mNumCyclesForProductivity;

type FGBuildableJumppad_base_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableJumppad_base_base_base & has_mNumCyclesForProductivity;

type FGBuildableJumppad_base_base_base = {
...
type FGBuildableLadder = docs_json_ts_common_classes_FGBuildableLadder & FGBuildable_base & FGBuildableLadder_base & has_mWidth;
...
type FGBuildableManufacturer_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableManufacturer_base_base & has_mNumCyclesForProductivity;

type FGBuildableManufacturer_base_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableManufacturer_base_base_base & has_mNumCyclesForProductivity;
...
type FGBuildableManufacturer_base_IsPowered = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableManufacturer_base_IsPowered_base & has_mNumCyclesForProductivity;

type FGBuildableManufacturer_base_IsPowered_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableManufacturer_base_IsPowered_base_base & has_mNumCyclesForProductivity;

type FGBuildableManufacturer_base_IsPowered_base_base = {
	IsPowered: docs_json_ts_common_types_bool_string,
};

type FGBuildableManufacturer_base_mProductionEffectsRunning = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableManufacturer_base_mProductionEffectsRunning_base & has_mNumCyclesForProductivity;

type FGBuildableManufacturer_base_mProductionEffectsRunning_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableManufacturer_base_mProductionEffectsRunning_base_base & has_mNumCyclesForProductivity;

type FGBuildableManufacturer_base_mProductionEffectsRunning_base_base = {
	mProductionEffectsRunning: docs_json_ts_common_types_bool_string,
};

type FGBuildableManufacturer_base_packager = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableManufacturer_base_packager_base & has_mNumCyclesForProductivity;

type FGBuildableManufacturer_base_packager_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableManufacturer_base_packager_base_base & has_mNumCyclesForProductivity;

type FGBuildableManufacturer_base_packager_base_base = {
	mCurrentColor_VFX: docs_json_ts_common_types_RGBA,
	CurrentPackagingMode: '',
};

type FGBuildableManufacturer_Build_AssemblerMk1_C = docs_json_ts_common_classes_FGBuildableManufacturer & FGBuildable_powered & FGBuildableManufacturer_base & FGBuildableManufacturer_base_IsPowered;

type FGBuildableManufacturer_Build_ConstructorMk1_C = docs_json_ts_common_classes_FGBuildableManufacturer & FGBuildable_powered & FGBuildableManufacturer_base & FGBuildableManufacturer_base_IsPowered;

type FGBuildableManufacturer_Build_FoundryMk1_C = docs_json_ts_common_classes_FGBuildableManufacturer & FGBuildable_powered & FGBuildableManufacturer_base & FGBuildableManufacturer_base_mProductionEffectsRunning;

type FGBuildableManufacturer_Build_ManufacturerMk1_C = docs_json_ts_common_classes_FGBuildableManufacturer & FGBuildable_powered & FGBuildableManufacturer_base;

type FGBuildableManufacturer_Build_OilRefinery_C = docs_json_ts_common_classes_FGBuildableManufacturer & FGBuildable_powered & FGBuildableManufacturer_base & FGBuildableManufacturer_base_IsPowered & FGBuildableManufacturer_base_mProductionEffectsRunning;

type FGBuildableManufacturer_Build_Packager_C = docs_json_ts_common_classes_FGBuildableManufacturer & FGBuildable_powered & FGBuildableManufacturer_base & FGBuildableManufacturer_base_IsPowered & FGBuildableManufacturer_base_mProductionEffectsRunning & FGBuildableManufacturer_base_packager;
...
type FGBuildableManufacturer_Build_SmelterMk1_C_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableManufacturer_base_base & FGBuildableManufacturer_base_mProductionEffectsRunning_base & has_mNumCyclesForProductivity;
...
type FGBuildablePipeline = docs_json_ts_common_classes_FGBuildablePipeline & FGBuildable_base & FGBuildablePipeline_base_root & FGBuildablePipeline_base_root_quantized & FGBuildablePipeline_base_spline;

type FGBuildablePipeline_base = FGBuildablePipeline_base_base & FGBuildablePipeline_base_no_indicator_base;

type FGBuildablePipeline_base_base = {
...
type FGBuildablePipeline_base_root_quantized = {
...
type FGBuildablePipeline_base_spline_base = FGBuildablePipeline_base_base & FGBuildablePipeline_base_no_indicator_base & has_mMeshLength & has_mSplineData;

type FGBuildablePipeline_junction = FGBuildable_powered & FGBuildablePipeline_junction_base;

type FGBuildablePipeline_junction_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildablePipeline_base_no_indicator_base & has_mNumCyclesForProductivity;

type FGBuildablePipelineJunction = docs_json_ts_common_classes_FGBuildablePipelineJunction & FGBuildablePipeline_junction & FGBuildablePipeline_junction_base & FGBuildablePipelineJunction_base;

type FGBuildablePipelineJunction_base = {
	mFluidBoxVolume: docs_json_ts_common_types_decimal_string,
};

type FGBuildablePipelinePump_base_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildablePipeline_base_base & FGBuildablePipeline_base_no_indicator_base & FGBuildablePipelinePump_powered_version_specific & has_mNumCyclesForProductivity;
...
type FGBuildablePipelinePump_powered_base_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildablePipelinePump_powered_version_specific & has_mNumCyclesForProductivity;

type FGBuildablePipelinePump_pump = docs_json_ts_common_classes_FGBuildablePipelinePump & FGBuildablePipeline_base & FGBuildablePipeline_base_base & FGBuildablePipeline_base_no_indicator_base & FGBuildablePipelinePump_base_base & FGBuildablePipelinePump_powered_version_specific & FGBuildablePipelinePump_powered_base & FGBuildablePipelinePump_powered_base_base & FGBuildablePipelinePump_pump_version_specific;
...
type FGBuildablePipelineSupport = docs_json_ts_common_classes_FGBuildablePipelineSupport & FGBuildable_base & FGBuildable_base_pre_update5 & FGBuildable_with_mLength & FGBuildablePipelineSupport_base & has_mCanStack & has_mStackHeight & has_mUseStaticHeight;
...
type FGBuildablePipeReservoir_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildablePipeReservoir_base_base & has_mNumCyclesForProductivity;

type FGBuildablePipeReservoir_base_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildablePipeReservoir_base_base_base & has_mNumCyclesForProductivity;

type FGBuildablePipeReservoir_base_base_base = {
...
type FGBuildablePole = docs_json_ts_common_classes_FGBuildablePole & FGBuildable_base & has_mCanStack & has_mHeight & has_mStackHeight & has_mUseStaticHeight;
...
type FGBuildableRadarTower_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableRadarTower_base_base & has_mNumCyclesForProductivity;
...
type FGBuildableRailroadStation = docs_json_ts_common_classes_FGBuildableRailroadStation & FGBuildable_powered & FGBuildableRailroadStation_base & FGBuildableTrainPlatform_base;
...
type FGBuildableRailroadTrack = docs_json_ts_common_classes_FGBuildableRailroadTrack & FGBuildable_base & FGBuildableRailroadTrack_base & has_mMeshLength;
...
type FGBuildableResourceExtractor_miner = docs_json_ts_0_3_7_7_classes_base_overridable_FGBuildableResourceExtractor_miner_base & docs_json_ts_0_3_7_7_classes_base_overridable_FGBuildableResourceExtractor_only_allow_certain_resources & FGBuildableResourceExtractor_base & FGBuildableResourceExtractor_miner_base & FGBuildableResourceExtractor_piped & FGBuildableResourceExtractor_piped_pre_1_0 & FGBuildableResourceExtractor_timed;
...
type FGBuildableResourceExtractor_miner_mk1 = docs_json_ts_common_classes_FGBuildableResourceExtractor & FGBuildable_powered & FGBuildableResourceExtractor & FGBuildableResourceExtractor_miner & FGBuildableResourceExtractor_miner_mk1_base;

type FGBuildableResourceExtractor_miner_mk1_base = {
	mDisplayName: 'Miner Mk1',
};

type FGBuildableResourceExtractor_miner_mk2 = docs_json_ts_common_classes_FGBuildableResourceExtractor & FGBuildable_powered & FGBuildableResourceExtractor & FGBuildableResourceExtractor_miner_mk2_base;
...
type FGBuildableResourceExtractor_miner_mk2_base_base = docs_json_ts_0_3_7_7_classes_base_overridable_FGBuildableResourceExtractor_miner_base & docs_json_ts_0_3_7_7_classes_base_overridable_FGBuildableResourceExtractor_only_allow_certain_resources & FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableResourceExtractor_miner_base & FGBuildableResourceExtractor_miner_mk2_base_base_base & FGBuildableResourceExtractor_piped & FGBuildableResourceExtractor_piped_pre_1_0 & FGBuildableResourceExtractor_timed & has_mNumCyclesForProductivity;
...
type FGBuildableResourceExtractor_oil = docs_json_ts_common_classes_FGBuildableResourceExtractor & FGBuildable_powered & FGBuildableResourceExtractor & FGBuildableResourceExtractor_oil_base;

type FGBuildableResourceExtractor_oil_base = docs_json_ts_0_3_7_7_classes_base_overridable_FGBuildableResourceExtractor_only_allow_certain_resources & FGBuildableResourceExtractor_base & FGBuildableResourceExtractor_oil_base_base & FGBuildableResourceExtractor_piped & FGBuildableResourceExtractor_piped_pre_1_0 & FGBuildableResourceExtractor_timed;
...
type FGBuildableResourceExtractor_water = docs_json_ts_common_classes_FGBuildableResourceExtractor & FGBuildable_powered & FGBuildableResourceExtractor & FGBuildableResourceExtractor_water_base;

type FGBuildableResourceExtractor_water_base = docs_json_ts_0_3_7_7_classes_base_overridable_FGBuildableResourceExtractor_only_allow_certain_resources & FGBuildableResourceExtractor_base & FGBuildableResourceExtractor_piped & FGBuildableResourceExtractor_piped_pre_1_0 & FGBuildableResourceExtractor_timed & FGBuildableResourceExtractor_water_base_base & FGBuildableResourceExtractor_water_base_base_version_specific;

type FGBuildableResourceExtractor_water_base_base = docs_json_ts_0_3_7_7_classes_base_overridable_FGBuildableResourceExtractor_only_allow_certain_resources & FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableResourceExtractor_piped & FGBuildableResourceExtractor_piped_pre_1_0 & FGBuildableResourceExtractor_timed & FGBuildableResourceExtractor_water_base_base_base & has_mNumCyclesForProductivity;
...
type FGBuildableResourceSink_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableResourceSink_base_base & has_mNumCyclesForProductivity;

type FGBuildableResourceSink_base_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableResourceSink_base_base_base & has_mNumCyclesForProductivity;

type FGBuildableResourceSink_base_base_base = {
...
type FGBuildableResourceSinkShop_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableResourceSinkShop_base_base & has_mNumCyclesForProductivity;

type FGBuildableResourceSinkShop_base_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableResourceSinkShop_base_base_base & has_mNumCyclesForProductivity;

type FGBuildableResourceSinkShop_base_base_base = {
...
type FGBuildableSpaceElevator_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableSpaceElevator_base_base & has_mNumCyclesForProductivity;

type FGBuildableSpaceElevator_base_base = {
	mMapText: 'Space Elevator',
};

type FGBuildableSplitterSmart = docs_json_ts_common_classes_FGBuildableSplitterSmart & FGBuildable_base & FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableAttachment_has_mCurrentInventoryIndex & FGBuildableAttachment_splitter & FGBuildableAttachment_splitter_base & FGBuildableAttachment_splitter_base_base_base & FGBuildableSplitterSmart_version_specific & has_mNumCyclesForProductivity;
...
type FGBuildableStair = docs_json_ts_common_classes_FGBuildableStair & FGBuildable_base & has_mDisableAttachmentSnapOn & has_mDisableSnapOn & has_mElevation & has_mHeight & has_mSize;

type FGBuildableStorage = docs_json_ts_common_classes_FGBuildableStorage & FGBuildable_powered & FGBuildableStorage_base;

type FGBuildableStorage_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableStorage_base_base & has_mNumCyclesForProductivity;

type FGBuildableStorage_base_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableStorage_base_base_base & has_mNumCyclesForProductivity;

type FGBuildableStorage_base_base_base = {
	mStackingHeight: docs_json_ts_common_types_decimal_string,
...
type FGBuildableTrainPlatform_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildableTrainPlatform_base_base & has_mNumCyclesForProductivity;
...
type FGBuildableTrainPlatform_with_storage = FGBuildable_powered & FGBuildable_powered_storage & FGBuildableTrainPlatform_base & FGBuildableTrainPlatform_with_storage_base;
...
type FGBuildableTrainPlatformCargo = docs_json_ts_common_classes_FGBuildableTrainPlatformCargo & FGBuildableTrainPlatform_with_storage & FGBuildableTrainPlatformCargo_base;
...
type FGBuildableWalkway = docs_json_ts_common_classes_FGBuildableWalkway & FGBuildable_base & has_mDisableSnapOn & has_mElevation & has_mSize;

type FGBuildableWall = docs_json_ts_common_classes_FGBuildableWall & FGBuildable_base & has_mHeight & has_mWidth;
...
type FGChainsaw = docs_json_ts_common_classes_FGChainsaw & FGChainsaw_pre_1_0 & FGChainsaw_pre_update8 & FGChainsaw_version_specific & FGEquipment & FGEquipment_base & FGEquipment_has_mPlayingSound;
...
type FGColorGun = docs_json_ts_common_classes_FGColorGun & FGColorGun_base & FGColorGun_base_base & FGWeaponProjectile_instant;

type FGColorGun_base = {
	mPrimaryColor: docs_json_ts_common_types_RGBA,
	mSecondaryColor: docs_json_ts_common_types_RGBA,
	mArmAnimation: 'AE_ColorGun',
};

type FGColorGun_base_base = {
...
type FGConsumableDescriptor = docs_json_ts_common_classes_FGConsumableDescriptor & FGConsumableDescriptor_base & FGDescriptor_sinkable & has_mResourceSinkPoints;

type FGConsumableDescriptor_base = {
...
type FGConveyorPoleStackable = docs_json_ts_common_classes_FGConveyorPoleStackable & FGBuildable_base & has_mCanStack & has_mHeight & has_mStackHeight & has_mUseStaticHeight;
...
type FGDescriptor_BuildMenu_base = {
...
type FGDescriptor_sinkable = FGDescriptor & FGDescriptor_base & has_mResourceSinkPoints;

type FGEquipment = {
	mAttachSocket: 'None' | 'hand_rSocket' | 'hand_lSocket' | 'jumpingStilt_lSocket' | 'helmetSocket',
};

type FGEquipment_base = docs_json_ts_0_3_7_7_classes_base_overridable_FGEquipment_version_specific & FGEquipment_has_mEquipmentSlot & FGEquipment_has_mUseDefaultPrimaryFire & FGEquipment_pre_1_0;

type FGEquipment_dispenser = FGEquipment & FGEquipment_base & FGEquipment_has_mPlaceDistanceMax;
...
type FGEquipmentStunSpear_base = {
	mDamage: docs_json_ts_common_types_integer_string,
};

type FGEquipmentStunSpear_base_base = FGEquipment & FGEquipment_base & FGEquipmentStunSpear_base_version_specific;
...
type FGEquipmentStunSpear_xenobasher = docs_json_ts_common_classes_FGEquipmentStunSpear & FGEquipmentStunSpear_base & FGEquipmentStunSpear_base_base & FGEquipmentStunSpear_xenobasher_base;
...
type FGEquipmentStunSpear_xenozapper = docs_json_ts_common_classes_FGEquipmentStunSpear & FGEquipmentStunSpear_base & FGEquipmentStunSpear_base_base & FGEquipmentStunSpear_xenozapper_base;

type FGEquipmentStunSpear_xenozapper_base = FGEquipment & FGEquipment_base & FGEquipment_has_mPlayingSound & FGEquipment_has_mRandomStingerAnim & FGEquipmentStunSpear_base_pre_1_0 & FGEquipmentStunSpear_base_pre_update8 & FGEquipmentStunSpear_base_version_specific;

type FGGasMask = docs_json_ts_common_classes_FGGasMask & FGEquipment & FGEquipment_base & FGEquipment_has_mFilterDuration & FGEquipment_has_effect_timer & FGEquipment_negates_damage & FGGasMask_base;
...
type FGGolfCartDispenser = docs_json_ts_common_classes_FGGolfCartDispenser & FGEquipment_dispenser & FGGolfCartDispenser_has_mArmAnimation;
...
type FGItemDescriptorNuclearFuel = docs_json_ts_common_classes_FGItemDescriptorNuclearFuel & FGDescriptor_sinkable & FGItemDescriptorNuclearFuel_version_specific;
...
type FGJumpingStilts = docs_json_ts_common_classes_FGJumpingStilts & FGEquipment & FGEquipment_base & FGJumpingStilts_base;
...
type FGNobeliskDetonator = docs_json_ts_common_classes_FGNobeliskDetonator & FGNobeliskDetonator_base & FGWeaponProjectile_thrown;

type FGNobeliskDetonator_base = {
	mArmAnimation: 'AE_Nobelisk',
};

type FGObjectScanner = docs_json_ts_common_classes_FGObjectScanner & FGEquipment & FGEquipment_base & FGEquipment_has_mPlayingSound & FGObjectScanner_has_mObjectDetails & FGObjectScanner_pre_1_0 & FGObjectScanner_pre_update8 & FGObjectScanner_version_specific;
...
type FGParachute = docs_json_ts_common_classes_FGParachute & FGEquipment & FGEquipment_base & FGParachute_has_mIsDeployed & FGParachute_has_mTerminalVelocityZ;
...
type FGPipeHyperStart = docs_json_ts_common_classes_FGPipeHyperStart & FGBuildable_powered & FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildable_with_mLength & FGPipeHyperStart_base & has_mCanStack & has_mNumCyclesForProductivity & has_mStackHeight & has_mUseStaticHeight;

type FGPipeHyperStart_base = FGBuildable_powered_pre_1_0 & FGBuildable_powered_version_specific & FGBuildable_with_mLength & FGPipeHyperStart_base_base_base & FGPipeHyperStart_pre_update8 & has_mNumCyclesForProductivity & has_mUseStaticHeight;
...
type FGPortableMinerDispenser = docs_json_ts_common_classes_FGPortableMinerDispenser & FGEquipment_dispenser & FGPortableMinerDispenser_version_specific;

type FGPortableMinerDispenser_version_specific = {
	mAllowedResourceForms: docs_json_ts_0_3_7_7_properties_mAllowedResourceForms,
};

type FGRecipe = docs_json_ts_common_classes_FGRecipe & FGRecipe_pre_update4 & FGRecipe_pre_update5 & FGRecipe_version_specific;
...
type FGResourceDescriptor = docs_json_ts_common_classes_FGResourceDescriptor & FGDescriptor_sinkable & FGResourceDescriptor_base & FGResourceDescriptor_pre_1_0;
...
type FGSchematic = docs_json_ts_0_3_7_7_classes_base_overridable_FGSchematic_version_specific & docs_json_ts_common_classes_FGSchematic & FGSchematic_pre_1_0 & FGSchematic_pre_update4 & FGSchematic_pre_update6;
...
type FGSnowballWeapon = docs_json_ts_common_classes_FGSnowballWeapon & FGSnowballWeapon_version_specific & FGWeaponProjectile_thrown;

type FGSnowballWeapon_version_specific = {
	mArmAnimation: 'AE_Generic1Hand',
};

type FGSuitBase = docs_json_ts_0_3_7_7_classes_base_overridable_FGSuitBase_pre_1_0 & docs_json_ts_common_classes_FGSuitBase & FGEquipment & FGEquipment_base & FGEquipment_has_mFilterDuration & FGEquipment_has_effect_timer & FGEquipment_negates_damage & FGSuitBase_base;
...
type FGVehicleDescriptor = docs_json_ts_common_classes_FGVehicleDescriptor & FGDescriptor_BuildMenu;

type FGWeapon_Equip_RebarGun_Projectile_C = docs_json_ts_common_classes_FGWeapon_Equip_RebarGun_Projectile_C & FGWeaponProjectile & FGWeaponProjectile_base & FGWeaponProjectile_has_mAttachSocket & FGWeaponProjectileFire_base_random & FGWeaponProjectileFire_base_version_specific;

type FGWeapon_Equip_Rifle_C = docs_json_ts_common_classes_FGWeapon_Equip_Rifle_C & FGWeaponInstantFire_base & FGWeaponProjectile_instant;
...
type FGWeaponInstantFire_base_base_base = {
...
type FGWeaponProjectile_base_version_specific = {
...
type FGWeaponProjectile_instant = FGWeaponProjectile & FGWeaponProjectile_base & FGWeaponProjectile_instant_base & FGWeaponProjectile_instant_base_version_specific;

type FGWeaponProjectile_instant_base = FGWeaponProjectile_base & FGWeaponProjectile_has_mAttachSocket;

type FGWeaponProjectile_instant_base_version_specific = {
	mInstantHitDamage: docs_json_ts_common_types_decimal_string,
	mWeaponTraceLength: docs_json_ts_common_types_decimal_string,
};

type FGWeaponProjectile_thrown = FGWeaponProjectile & FGWeaponProjectile_thrown_base & FGWeaponProjectile_thrown_base_base & FGWeaponProjectile_thrown_base_pre_1_0;

type FGWeaponProjectile_thrown_base = {
	mExplosiveData: {
...
export type {
	...
	FGBuildableFactory_landing_pad_version_specific,
	...
	FGSnowballWeapon,
	FGSnowballWeapon_version_specific,
	FGSuitBase,
	FGSuitBase_base,
	FGVehicleDescriptor,
