...
export function array_is_non_empty<T extends any = any>(maybe:T[]) : maybe is [T, ...T[]] {
...
export function object_has_array_property<T extends string = string> (
	...
	return object_has_property(maybe, property) && value_is_array(maybe[property]);
}
...
export function object_only_has_that_property<T extends string = string> (
	...
	return object_has_property(maybe, property) && 1 === Object.keys(maybe).length;
}
