import {object_has_non_empty_array_property, object_has_property, SupportedSubSchemaType} from './CustomPairingTypes';
import {typed_string_const_value_regex, typed_string_const_value_regex__native} from './TypedStringConst';
import {create_typed_union, non_empty_string_literal_union, possibly_create_lazy_union} from '../TsFactoryWrapper';
...
class TypedStringEnum extends SupportedSubSchemaType<enum_schema_type, non_empty_string_literal_union> {
