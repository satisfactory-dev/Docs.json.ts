...
export class DocsTsGenerator {
	...
	// eslint-disable-next-line max-len
	async schema_version_1_0_1_0(): Promise<DocsSchemaByVersion['version_1_0_1_0']['en_US']['schema']>
	{
		const schema = this.schema_data.version_1_0_1_0.en_US.schema;

		// eslint-disable-next-line max-len
		await this.validate_schema<DocsSchemaByVersion['version_1_0_1_0']['en_US']['schema']>(
			'version_1_0_1_0',
			schema,
		);
