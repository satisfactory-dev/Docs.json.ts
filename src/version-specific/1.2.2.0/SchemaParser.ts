...
export function add_schemas(parser: SchemaParser) {
	...
	parser.add_schema(release_1_2_2_0__base_classes);
	parser.add_schema(release_1_2_2_0__classes);
	parser.add_schema(release_1_2_2_0);
}
