...
import {
	configure_parser,
} from '../../../src/version-specific/1.1.2.2/SchemaParser.ts';
...
// eslint-disable-next-line @stylistic/max-len
import release_1_1_properties from '../../../schema/1.1.2.2/properties.json' with {
	type: 'json',
};

// eslint-disable-next-line @stylistic/max-len
import release_1_1_classes__base from '../../../schema/1.1.2.2/base-classes.json' with {
	type: 'json',
};

import release_1_1_classes from '../../../schema/1.1.2.2/classes.json' with {
	type: 'json',
};
...
async function generation_factory(
	...
	console.log(`Generating Version 1.1 ${lang}`);
	...
	const adjuster = new FilenameAdjuster(
		{
			...
			[release_1_1.$id]: {
				...
				data: `./generated-types/1.1.2.2/${lang}.data.ts`,
			},
		},
