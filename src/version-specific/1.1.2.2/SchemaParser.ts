...
import {
	add_schemas as add_schemas_version_1_0,
} from '../1.0.1.4/SchemaParser.ts';
...
export function add_schemas(parser: SchemaParser) {
	add_schemas_version_1_0(parser);

	parser.add_schema(release_1_1__properties);
	parser.add_schema(release_1_1__classes__base);
	parser.add_schema(release_1_1__classes);
	parser.add_schema(release_1_1);
}
