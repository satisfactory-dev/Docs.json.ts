	...
	return {
		...
		PrefixedStringMatcher: ({ajv}) => [
			...([
				...
				PrefixedStringMatcher(ajv, mode, 'Engine'),
				PrefixedStringMatcher(ajv, mode, 'TemplateSequence'),
				PrefixedStringMatcher(ajv, mode, 'FactoryGame'),
				PrefixedStringMatcher(ajv, mode, 'AkAudio'),
			]),
		],
