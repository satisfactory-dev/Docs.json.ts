...
import {
	add_schemas as add_schemas_version_1_1,
} from '../1.1.2.2/SchemaParser.ts';
...
export function add_schemas(parser: SchemaParser) {
	add_schemas_version_1_1(parser);

	parser.add_schema(release_1_2__properties);
	parser.add_schema(release_1_2__classes__base);
	parser.add_schema(release_1_2__classes);
	parser.add_schema(release_1_2);
}
