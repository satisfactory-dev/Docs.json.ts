...
import {
	configure_parser,
} from '../../../src/version-specific/1.2.0.0/SchemaParser.ts';
...
// eslint-disable-next-line @stylistic/max-len
import release_1_2_properties from '../../../schema/1.2.0.0/properties.json' with {
	type: 'json',
};

// eslint-disable-next-line @stylistic/max-len
import release_1_2_classes__base from '../../../schema/1.2.0.0/base-classes.json' with {
	type: 'json',
};

import release_1_2_classes from '../../../schema/1.2.0.0/classes.json' with {
	type: 'json',
};
...
async function generation_factory(
	...
	const adjuster = new FilenameAdjuster(
		{
			...
			[release_1_2.$id]: {
				...
				data: `./generated-types/1.2.0.0/${lang}.data.ts`,
			},
		},
	...
	if (process_types) {
		schema_set.push(
			...
			release_1_2_properties,
			release_1_2_classes__base,
			release_1_2_classes,
		);
